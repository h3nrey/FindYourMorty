              ...
              props.map(character => {
                return(
                  ...
                  >
                    ...
                    <div 
                    className="absolute bg-darkPurple flex flex-col items-center rounded-3xl bottom-0 md:-bottom-16 md:group-hover:bottom-0 w-full py-4 pt-6 gap-8 transition-all">
